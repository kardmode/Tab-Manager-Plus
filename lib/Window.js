	...
	render: function render() {var _this = this;
		...
		if (!hideWindow) {
			if (!!this.props.tabactions) {
				...
				React.DOM.div({ className: "icon tabaction sort " + (this.props.layout.indexOf("blocks") > -1 ? "" : "windowaction"), title: "Sort tabs in this window", onClick: this.sort, onMouseEnter: this.props.hoverIcon }),
